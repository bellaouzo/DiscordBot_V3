...
export class UserSelectMenuRouter {
  ...
  RegisterUserSelectMenu(options: RegisterUserSelectMenuOptions): RegisteredUserSelectMenu {
  ...
  async HandleUserSelectMenu(interaction: UserSelectMenuInteraction): Promise<boolean> {
...
export function CreateUserSelectMenuRouter(logger: Logger): UserSelectMenuRouter {
